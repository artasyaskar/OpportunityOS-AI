...
export default function DashboardPage() {
  ...
  return (
    <div>
      ...
      {/* EXECUTION VELOCITY & TARGET READINESS */}
      <div className="card-magnetic glow-border page-transition" style={{ padding: '24px', marginBottom: '32px', border: '1px solid rgba(99,102,241,0.2)', background: 'linear-gradient(135deg, rgba(99,102,241,0.04) 0%, rgba(16,185,129,0.03) 100%)', borderRadius: '16px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', flexWrap: 'wrap', gap: '8px' }}>
          <div>
            <h3 style={{ fontFamily: 'Space Grotesk, sans-serif', fontSize: '15px', fontWeight: 700, color: 'white', display: 'flex', alignItems: 'center', gap: '8px', margin: 0 }}>
              <Activity size={18} className="text-indigo-400" /> Execution Velocity & Target Readiness
            </h3>
            <p style={{ color: 'rgba(255,255,255,0.5)', fontSize: '12px', marginTop: '4px', margin: 0 }}>
              Operational readiness and deadline metrics derived directly from your active profile & pipeline.
            </p>
          </div>
          <span className="badge badge-indigo" style={{ fontSize: '9px', fontWeight: 700 }}>PIPELINE STATUS</span>
        </div>
        <div className="score-rings-grid" style={{ gap: '20px' }}>
          <div>
            <div style={{ fontSize: '10px', color: 'rgba(255,255,255,0.4)', fontWeight: 700, letterSpacing: '0.5px' }}>MATCHED TARGETS</div>
            <div style={{ fontFamily: 'Space Grotesk, sans-serif', fontSize: '24px', fontWeight: 800, color: '#818cf8', marginTop: '6px' }}>{metrics.opportunitiesFound}</div>
            <div style={{ fontSize: '11px', color: 'rgba(255,255,255,0.45)', marginTop: '4px' }}>Filtered by profile DNA</div>
          </div>
          <div>
            <div style={{ fontSize: '10px', color: 'rgba(255,255,255,0.4)', fontWeight: 700, letterSpacing: '0.5px' }}>ACTIVE PIPELINE</div>
            <div style={{ fontFamily: 'Space Grotesk, sans-serif', fontSize: '24px', fontWeight: 800, color: '#10b981', marginTop: '6px' }}>{apps.length} Tracked</div>
            <div style={{ fontSize: '11px', color: 'rgba(255,255,255,0.45)', marginTop: '4px' }}>Applications in progress</div>
          </div>
          <div>
            <div style={{ fontSize: '10px', color: 'rgba(255,255,255,0.4)', fontWeight: 700, letterSpacing: '0.5px' }}>UPCOMING DEADLINES</div>
            <div style={{ fontFamily: 'Space Grotesk, sans-serif', fontSize: '24px', fontWeight: 800, color: '#f59e0b', marginTop: '6px' }}>{metrics.deadlinesThisMonth}</div>
            <div style={{ fontSize: '11px', color: 'rgba(255,255,255,0.45)', marginTop: '4px' }}>Due within 30 days</div>
          </div>
          <div>
            <div style={{ fontSize: '10px', color: 'rgba(255,255,255,0.4)', fontWeight: 700, letterSpacing: '0.5px' }}>AVERAGE MATCH FIT</div>
            <div style={{ fontFamily: 'Space Grotesk, sans-serif', fontSize: '24px', fontWeight: 800, color: '#06b6d4', marginTop: '6px' }}>{metrics.successProbabilityAvg}%</div>
            <div style={{ fontSize: '11px', color: 'rgba(255,255,255,0.45)', marginTop: '4px' }}>AI profile compatibility</div>
          </div>
        </div>
      </div>
